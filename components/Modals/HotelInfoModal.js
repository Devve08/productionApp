  ...
  return (
    ...
    >
      ...
      <ScrollView >
            ...
            <Image style={{width: 150, height: 150, marginVertical: 20, alignSelf: 'center'}} source={{uri: item.hotel_profile}} />
          ...
          {item.h_map_url && <Text onPress={()=>openPDF(item.h_map_url)} style={styles.address}>{item.h_hotel_address}</Text>}
            <View style={styles.socials}>
              <TouchableOpacity>
            <FontAwesome onPress={()=>openPDF(item.h_instagram_account)} size={30} name='instagram' />
            </TouchableOpacity>
            <TouchableOpacity>
            <FontAwesome onPress={()=>openPDF(item.h_twitter_account)} name='twitter-square' size={30} />
            </TouchableOpacity>
            <TouchableOpacity>
            <FontAwesome onPress={()=>openPDF(item.h_facebook_account)} name='facebook-official' size={30} />
            </TouchableOpacity>
            </View>
...
const styles = StyleSheet.create({
  ...
  container: {width: "100%", height: '90%', backgroundColor: 'white', borderRadius: 10, alignItems: 'center', justifyContent: 'center', flexDirection: 'column'},
  socials:{flexDirection: 'row', alignSelf: 'center', justifyContent: 'space-between', width: '50%', paddingVertical: 10}
